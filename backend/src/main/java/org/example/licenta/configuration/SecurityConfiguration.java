...
//                    toate permisiunile
                    ...
                    authorize.requestMatchers(new AntPathRequestMatcher("/events")).permitAll();
                    authorize.requestMatchers(new AntPathRequestMatcher("/reservations")).permitAll();
...
//                    permisiuni admin
                    ...
                    authorize.requestMatchers(new AntPathRequestMatcher("/maps/create")).hasRole("ADMIN");
                    authorize.requestMatchers(new AntPathRequestMatcher("/maps/{id}/delete")).hasRole("ADMIN");
                    authorize.requestMatchers(new AntPathRequestMatcher("/events/create")).hasRole("ADMIN");
...
//                    permisiuni user si admin
                    ...
                    authorize.requestMatchers(new AntPathRequestMatcher("/{imgId}/{date}/reservation/{seatId}")).hasAnyRole("USER", "ADMIN");
                    ...
                    authorize.requestMatchers(new AntPathRequestMatcher("/maps/{id}/availabilities/{date}/{hour}")).hasAnyRole("USER", "ADMIN");
                    authorize.requestMatchers(new AntPathRequestMatcher("/my/reservations/{id}")).hasAnyRole("USER", "ADMIN");
                    authorize.requestMatchers(new AntPathRequestMatcher("/{imgId}/{date}/reservation/meetingRoom/{roomId}")).hasAnyRole("USER", "ADMIN");
                });
